...
const styles = StyleSheet.create({
  ...
  progressBar: { height: 6, backgroundColor: '#3498db', borderRadius: 3 },
  header: { fontSize: 22, fontWeight: 'bold', marginBottom: 20, textAlign: 'center', color: '#2c3e50' },
  stepTitle: { fontSize: 18, fontWeight: '600', color: '#3498db', marginBottom: 15 },
  ...
  nextButton: { flex: 1, backgroundColor: '#3498db', padding: 16, borderRadius: 10, alignItems: 'center' },
